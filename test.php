...
<div class="change">
    ...
    <?php
              ...
              if ($_SESSION['role'] === 0) {
                  ...
                  // Hiển thị thông tin các id_project
...
echo "</div>";
                      // Hiển thị các thông tin khác từ bảng project hoặc user_apply tùy theo yêu cầu
                  }
              } else {
...
echo "<div id='pagination'></div>";
echo "</div>";
                      // Hiển thị các thông tin khác từ bảng users hoặc candidate tùy theo yêu cầu
                  }
              }
